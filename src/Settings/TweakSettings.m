				...
				[SCISetting navigationCellWithTitle:SCILocalized(@"General")
										...
										navSections:@[@{
											...
											@"rows": @[
												...
												[SCISetting switchCellWithTitle:SCILocalized(@"Hide Testflight") subtitle:SCILocalized(@"Hides Instagram TestFlight beta update popup.") defaultsKey:@"hide_testflight_nag"],
